...
using SportLeagueASPNetCoreTest.Controllers.Authotization;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddAuthorization(config =>
            {
                ...
                config.AddPolicy("EditMovie", policyBuilder =>
                {
                    policyBuilder.AddRequirements(new SameAuthorRequirement());
                });
            });
